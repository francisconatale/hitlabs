...
export function EditorialWorksList({
  ...
  return (
    <div className="w-full bg-transparent text-[#111]">
      <div className="pt-20 pb-24 px-6 md:px-12 max-w-[1600px] mx-auto">
          ...
          {projects.map((p, idx) => (
            <div key={p.id} className="flex flex-col">
              <div className="flex flex-col justify-between items-start mb-4">
                ...
                <h2 className="font-[family-name:var(--font-display)] text-2xl md:text-3xl tracking-tighter uppercase leading-[0.9] opacity-90">
                  {p.title}
                </h2>
              </div>
              ...
              >
                 <img 
                   ...
                   src={p.images[0]} 
                   alt={p.title} 
                   className="w-1/2 h-1/2 object-contain mix-blend-multiply transition-transform hover:scale-110 duration-700" 
                 />
              </motion.div>

              <div className="mt-4 flex flex-col justify-between items-start border-t border-black/10 pt-4 gap-4">
